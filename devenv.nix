...
in {
  ...
  enterShell = ''
    ...
    echo "  claude        → Generate Claude config for macOS/Linux"
    echo "  claude-win    → Generate Claude config for Windows"
    echo "  claude-vm     → Generate Claude config for macOS/Linux with VM option"
    echo "  claude-win-vm → Generate Claude config for Windows with VM option"
    echo ""
