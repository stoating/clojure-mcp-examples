...
in {
  ...
  enterShell = ''
    ...
    echo "  claude-vm     → Generate Claude config for macOS/Linux with VM option and copy to destination"
    echo "  claude-win-vm → Generate Claude config for Windows with VM option and copy to destination"
    echo ""
